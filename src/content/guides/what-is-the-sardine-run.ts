...
export const guide: Guide = {
  slug: "what-is-the-sardine-run",
  title: "What Is the Sardine Run? The Greatest Shoal on Earth, Explained",
  metaTitle: "What Is the Sardine Run? Greatest Shoal Explained",
  metaDescription:
    "The sardine run is South Africa's winter fish migration, billions of Sardinops sagax chased up the Wild Coast. What it is, why it happens, and where to watch.",
  eyebrow: "Field Guide",
  heroImage: {
    src: "/images/hero-baitball.webp",
    alt: "A tight bait ball of sardines packed into a silver sphere near the surface, with predators closing in from below.",
  },
  intro: [
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "None of it is guaranteed on any given day. The run depends on water temperature, wind and current, and in warm years it can be weak or barely appear. What is reliable is the season and the coast. Understanding the [science behind why it happens](/guides/why-does-the-sardine-run-happen) is the difference between expecting a wildlife show and reading the ocean like a guide does.",
      ],
    },
    {
      h2: "The fish at the centre of it: Sardinops sagax",
      id: "the-fish",
      paragraphs: [
      ...
      image: {
        src: "/images/shoal-shimmer.webp",
        alt: "Thousands of sardines flashing silver as the shoal turns in unison underwater.",
        caption: "Tight schooling and synchronised turns give the shoal its silver shimmer.",
      },
    },
    {
      h2: "Why it happens here, and almost nowhere else at this scale",
      id: "why-here",
      paragraphs: [
    ...
    },
    {
      ...
      table: {
        caption: "The sardine run by the numbers",
    ...
    {
      h2: "Why it is compared to the wildebeest migration",
      id: "wildebeest-comparison",
      paragraphs: [
    ...
    },
    {
      ...
      image: {
        src: "/images/gannets-dive.webp",
        alt: "Cape gannets folding their wings and plunging into the sea above a sardine shoal.",
        caption: "A column of diving gannets is the surface signal that a shoal is below.",
      },
    },
    {
      h2: "Where and when to see it",
      id: "where-and-when",
      paragraphs: [
        ...
        "This southern-first pattern is why we run our expeditions from Chintsa, near East London. The southern Wild Coast catches the early phase of the run before the main fleet follows it north, and Chintsa sits about 40 minutes from King Phalo Airport, which has daily direct flights from Johannesburg and Cape Town. That combination of an earlier, less crowded stretch and easy access is the case we make on the [East London and Chintsa guide](/guides/sardine-run-east-london-chintsa).",
        "Most of what you see happens at or near the surface, so you do not need a scuba qualification to take part; it works as an ocean safari from the boat and by snorkel, with scuba used only on stable bait balls at the skipper's discretion. If you want to build a trip around it, our [expedition packages](/packages) cover the sea days, the spotter support and the logistics. The next bookable season is 2027.",
      ],
      image: {
        src: "/images/wild-coast-aerial.webp",
        alt: "Aerial view of the Eastern Cape Wild Coast coastline where the sardine run passes.",
        caption: "The run tracks the Eastern Cape coast, appearing in the south before moving north.",
      },
    },
  ],
  faqs: [
    {
      q: "Is the sardine run really visible from space?",
      a: "On the biggest years, yes. The shoals can run several kilometres long and tens of metres deep, and a mass of fish that size discolours the water enough to be picked up from aircraft and satellite sensors. Spotter planes use the same aerial visibility every day of the season to find shoals and direct boats to them.",
    },
    {
      q: "How is the sardine run different from a bait ball?",
    ...
    {
      q: "What kind of fish is a sardine, exactly?",
      a: "The fish behind the run is the Southern African pilchard, *Sardinops sagax*. It grows to about 25cm, lives roughly five years, and filter-feeds on plankton. It spawns on the Agulhas Bank in summer, where a single female can release up to around 27,500 eggs, and the population that builds from that spawning is what later moves up the coast in winter.",
    },
    {
      q: "Why is it called the greatest shoal on Earth?",
      a: "Because of sheer biomass moving at once. The run is often ranked as the largest animal migration by numbers, with shoals reported up to 7km long, and it draws one of the densest predator gatherings in the ocean. That scale is why it is regularly compared to the wildebeest migration on land.",
    },
    {
      q: "Does the sardine run happen anywhere else in the world?",
      a: "Smaller sardine aggregations exist, notably the year-round resident bait ball at Moalboal in the Philippines and seasonal events off Mexico. None move fish on the scale of the South African run or gather the same predator cast, which comes from a specific mix of a cold winter corridor, a warm current and a narrowing continental shelf.",
    },
    {
      q: "Is the sardine run the same as the wildebeest migration, just in the sea?",
      a: "It is the closest ocean equivalent by volume of life moving at once, and both are seasonal, resource-driven events with a following of predators. The main difference is that the sardines move underwater and mostly out of sight, so you read surface signs like diving gannets and working dolphins rather than watching the whole herd cross open ground.",
    },
    {
      q: "Does the run happen at the same time every year?",
      a: "The season is reliable, May to July, but the timing and strength within it vary year to year because the run is driven by water temperature, wind and current. Warm years produce weak or failed runs. The action generally appears first in the south around East London and Chintsa before moving north up the Wild Coast.",
    },
  ],
  cta: {
    heading: "See the greatest shoal on Earth for yourself",
    body: "Sardine Run Africa runs 7-day expeditions from Chintsa, near East London, on the southern Wild Coast where the run appears first each winter. The next season is 2027. Browse our packages or get in touch to plan your dates and hold a seat on the boat.",
  },
  related: [
    "sardine-run-season-dates",
    "sardine-run-route",
    "sardine-run-marine-life",
  ],
